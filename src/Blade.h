...
namespace blade
{
	...
	static const bool  DumpPreprocessedScriptOnDisk		= DEV_BUILD;	// Developer Mode
	static const bool  GenerateControlFlowWrappers		= false;			// Optional
...
public:
	...
	const json_t GetBindingsDatabase() const;
...
private:
	...
	mutable json_t			scriptMetadata = json_t();
...
public:
	...
	String PreProcessScript(json_t& metadata);
	bool CompileScript(bool dryPass = false);
	bool PostProcessScript(BladeCompiler* compiler, json_t& metadata);
	...
	const json_t& GetScriptMetadata() const { return scriptMetadata; }
...
class BladeScriptInstance : public ScriptInstanceExtension
{
protected:
